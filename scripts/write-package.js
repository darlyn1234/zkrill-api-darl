...
async function writePackageJson () {
  ...
  if (!libExists) {
    console.error('@darlyn1234/zkrill-api-darl:', 'Lib folder not found after compiling TypeScript')
    process.exit(1)
  }
  ...
  } else console.warn('@darlyn1234/zkrill-api-darl:', 'CJS folder not found')
  ...
  } else console.warn('@darlyn1234/zkrill-api-darl:', 'ESM folder not found')
  ...
  if (!typesExists && !libEsmExists && !libCjsExists) {
    console.error('@darlyn1234/zkrill-api-darl:', 'No compiled TypeScript files found')
    process.exit(1)
  }
}
